...
public class WorkbenchguiScreen extends AbstractContainerScreen<WorkbenchguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("elec_tronics:textures/workbenchgui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Inventory", 7, 94, -12829636);
		this.font.draw(poseStack, "Engineer's Workbench", 6, 4, -12829636);
	}
