...
public class TankT1GUIMenuScreen extends AbstractContainerScreen<TankT1GUIMenuMenu> {
	private final static HashMap<String, Object> guistate = TankT1GUIMenuMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TankT1GUIMenuScreen(TankT1GUIMenuMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("elec_tronics:textures/screens/tankt1guimenu.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.elec_tronics.tankt1guimenu.label_tank_tier_1"), 36, 5, -16737895);
	}
