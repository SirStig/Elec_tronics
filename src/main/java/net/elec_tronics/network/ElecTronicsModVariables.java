...
public class ElecTronicsModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		ElecTronicsMod.addNetworkMessage(SavedDataSyncMessage.class, SavedDataSyncMessage::buffer, SavedDataSyncMessage::new,
	...
	public static class EventBusVariableHandlers {
		...
		public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
			if (!event.getPlayer().level.isClientSide()) {
				...
				if (mapdata != null)
					ElecTronicsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getPlayer()),
	...
	public static class MapVariables extends SavedData {
		...
		public String fluidpumpblockstate = "";
		...
		public void read(CompoundTag nbt) {
			fluidpumpblockstate = nbt.getString("fluidpumpblockstate");
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.putString("fluidpumpblockstate", fluidpumpblockstate);
			return nbt;
		}
