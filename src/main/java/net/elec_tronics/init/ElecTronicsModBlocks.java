...
public class ElecTronicsModBlocks {
	...
	public static final RegistryObject<Block> ENGINEERS_WORK_BENCH_SIDE = REGISTRY.register("engineers_work_bench_side",
			() -> new EngineersWorkBenchSideBlock());
	public static final RegistryObject<Block> ENGINEERS_WORK_BENCH_TOP = REGISTRY.register("engineers_work_bench_top",
			() -> new EngineersWorkBenchTopBlock());
	public static final RegistryObject<Block> ENGINEERS_WORK_BENCH_TOP_SIDE = REGISTRY.register("engineers_work_bench_top_side",
			() -> new EngineersWorkBenchTopSideBlock());
	...
	public static final RegistryObject<Block> CABLE_T_UPAND_DOWN_T_1 = REGISTRY.register("cable_t_upand_down_t_1",
			() -> new CableTUpandDownT1Block());
	...
	public static final RegistryObject<Block> CABLE_JUNCTION_DOWN_T_1 = REGISTRY.register("cable_junction_down_t_1",
			() -> new CableJunctionDownT1Block());
	public static final RegistryObject<Block> CABLE_JUNCTION_UPAND_DOWN_T_1 = REGISTRY.register("cable_junction_upand_down_t_1",
			() -> new CableJunctionUpandDownT1Block());
	...
	public static final RegistryObject<Block> BASEWIRECON_2ANGLEDOWN = REGISTRY.register("basewirecon_2angledown",
			() -> new Basewirecon2angledownBlock());
	...
	public static final RegistryObject<Block> BASEWIRECON_3DOWNANDUP = REGISTRY.register("basewirecon_3downandup",
			() -> new Basewirecon3downandupBlock());
	public static final RegistryObject<Block> BASEWIRECON_3DOWNANGLE = REGISTRY.register("basewirecon_3downangle",
			() -> new Basewirecon3downangleBlock());
	...
	public static final RegistryObject<Block> BASEWIRECON_4UPANDDOWN = REGISTRY.register("basewirecon_4upanddown",
			() -> new Basewirecon4upanddownBlock());
	public static final RegistryObject<Block> BASEWIRECON_4UPANDDOWNSTRAIGHT = REGISTRY.register("basewirecon_4upanddownstraight",
			() -> new Basewirecon4upanddownstraightBlock());
	...
	public static final RegistryObject<Block> PIPEJUNCTIONUPANDDOWN = REGISTRY.register("pipejunctionupanddown",
			() -> new PipejunctionupanddownBlock());
	public static final RegistryObject<Block> PIPEJUNCTIONUPANDDOWN_2 = REGISTRY.register("pipejunctionupanddown_2",
			() -> new Pipejunctionupanddown2Block());
	public static final RegistryObject<Block> PIPEJUNCTIONUPANDDOWNSTRAIGHT = REGISTRY.register("pipejunctionupanddownstraight",
			() -> new PipejunctionupanddownstraightBlock());
	...
	public static final RegistryObject<Block> MANUAL_FLUID_PUMPDOWN_2 = REGISTRY.register("manual_fluid_pumpdown_2",
			() -> new ManualFluidPumpdown2Block());
