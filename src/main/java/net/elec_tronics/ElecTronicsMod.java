...
public class ElecTronicsMod {
	public static final Logger LOGGER = LogManager.getLogger(ElecTronicsMod.class);
	public static final String MODID = "elec_tronics";
	...
	public ElecTronicsMod() {
		...
		ElecTronicsModMenus.REGISTRY.register(bus);
		ElecTronicsModFeatures.REGISTRY.register(bus);

		ElecTronicsModFluids.REGISTRY.register(bus);
		ElecTronicsModFluidTypes.REGISTRY.register(bus);
	}
