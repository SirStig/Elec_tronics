...
public class BasecableT1Block extends Block
		implements
	...
	public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
		return new BasecableT1BlockEntity(pos, state);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(ElecTronicsModBlocks.BASECABLE_T_1, renderType -> renderType == RenderType.cutout());
	}
