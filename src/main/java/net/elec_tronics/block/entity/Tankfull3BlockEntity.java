...
public class Tankfull3BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Tankfull3BlockEntity(BlockPos position, BlockState state) {
		super(ElecTronicsModBlockEntities.TANKFULL_3.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("tankfull_3");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Tank 3");
	}
