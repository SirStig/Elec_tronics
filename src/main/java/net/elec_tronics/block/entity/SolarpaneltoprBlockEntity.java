...
public class SolarpaneltoprBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public SolarpaneltoprBlockEntity(BlockPos position, BlockState state) {
		super(ElecTronicsModBlockEntities.SOLARPANELTOPR.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("solarpaneltopr");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(50, 50, 50, 50) {
		@Override
