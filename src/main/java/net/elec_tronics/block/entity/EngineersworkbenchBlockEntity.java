...
public class EngineersworkbenchBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return new TextComponent("engineersworkbench");
	}
	...
	public Component getDisplayName() {
		return new TextComponent("Engineers Workbench");
	}
