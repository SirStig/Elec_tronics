...
public class QuarryT1GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public QuarryT1GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElecTronicsModMenus.QUARRY_T_1_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 32, 63) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 58, 63) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ElecTronicsModItems.REFINED_OIL_ITEM.get() == stack.getItem();
			}
		}));
