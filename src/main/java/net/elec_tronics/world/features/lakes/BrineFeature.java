...
public class BrineFeature extends LakeFeature {
	public static BrineFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BrineFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("elec_tronics:brine", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(ElecTronicsModBlocks.BRINE.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("elec_tronics:brine", CONFIGURED_FEATURE,
