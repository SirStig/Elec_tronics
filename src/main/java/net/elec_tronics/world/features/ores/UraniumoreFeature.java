...
public class UraniumoreFeature extends OreFeature {
	public static final UraniumoreFeature FEATURE = (UraniumoreFeature) new UraniumoreFeature().setRegistryName("elec_tronics:uraniumore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(UraniumoreFeatureRuleTest.INSTANCE, ElecTronicsModBlocks.URANIUMORE.defaultBlockState(), 3))
	...
	private static class UraniumoreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<UraniumoreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("elec_tronics:uraniumore_match"), () -> codec);
