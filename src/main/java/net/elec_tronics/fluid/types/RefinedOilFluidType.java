...
public class RefinedOilFluidType extends FluidType {
	public RefinedOilFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("elec_tronics:block/refinedoilstill"), FLOWING_TEXTURE = new ResourceLocation("elec_tronics:block/refinedoilflowing");
