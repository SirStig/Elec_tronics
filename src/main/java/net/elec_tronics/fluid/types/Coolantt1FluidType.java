...
public class Coolantt1FluidType extends FluidType {
	public Coolantt1FluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("elec_tronics:block/coolantstill"), FLOWING_TEXTURE = new ResourceLocation("elec_tronics:block/coolantflowing");
